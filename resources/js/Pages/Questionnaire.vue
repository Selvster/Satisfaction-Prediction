    ...
    <QuestionnaireLayout>
        ...
        <template #main>
            <div v-if="success" class="bg-green-100 border-l-4 border-green-400 p-4 rounded mb-4">
                <p class="text-lg text-green-700 font-medium">Prediction : Satisfied</p>
            </div>
            ...
            <div class="max-w-7xl mx-auto bg-gray-200 mt-2 p-4 border rounded">
                <form @submit.prevent="submitForm">
                    ...
                    <select id="type_of_travel" v-model="form.type_of_travel"
                        class="shadow appearance-none border rounded w-full mt-1 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    ...
                    <TextInput id="departure_delay" type="number" class="mt-1 block w-full" v-model="form.departure_delay"
                        required />
                    ...
                    <select id="departure_and_arrival_time_convenient" v-model="form.departure_and_arrival_time_convenient"
                        class="shadow appearance-none border rounded w-full mt-1 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                    ...
                    <select id="ease_of_online_booking" v-model="form.ease_of_online_booking"
                        class="shadow appearance-none border rounded w-full mt-1 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        <option value="1">Very Dissatisfied</option>
                        <option value="2">Dissatisfied</option>
                        <option value="3">Neutral</option>
                    ...
                    <select id="check_in_service" v-model="form.check_in_service"
                        class="shadow appearance-none border rounded w-full mt-1 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        <option value="1">Very Dissatisfied</option>
                        <option value="2">Dissatisfied</option>
                        <option value="3">Neutral</option>
                    ...
                    <select id="online_boarding" v-model="form.online_boarding"
                        class="shadow appearance-none border rounded w-full mt-1 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        <option value="1">Very Dissatisfied</option>
                        <option value="2">Dissatisfied</option>
                        <option value="3">Neutral</option>
                    ...
                    <select id="gate_location" v-model="form.gate_location"
                        class="shadow appearance-none border rounded w-full mt-1 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        <option value="1">Very Dissatisfied</option>
                        <option value="2">Dissatisfied</option>
                        <option value="3">Neutral</option>
                    ...
                    <select id="on_board_service" v-model="form.on_board_service"
                        class="shadow appearance-none border rounded w-full mt-1 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        <option value="1">Very Dissatisfied</option>
                        <option value="2">Dissatisfied</option>
                        <option value="3">Neutral</option>
                    ...
                    <select id="seat_comfort" v-model="form.seat_comfort"
                        class="shadow appearance-none border rounded w-full mt-1 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        <option value="1">Very Dissatisfied</option>
                        <option value="2">Dissatisfied</option>
                        <option value="3">Neutral</option>
                    ...
                    <select id="leg_room_service" v-model="form.leg_room_service"
                        class="shadow appearance-none border rounded w-full mt-1 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        <option value="1">Very Dissatisfied</option>
                        <option value="2">Dissatisfied</option>
                        <option value="3">Neutral</option>
                    ...
                    <select id="cleanliness" v-model="form.cleanliness"
                        class="shadow appearance-none border rounded w-full mt-1 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        <option value="1">Very Dissatisfied</option>
                        <option value="2">Dissatisfied</option>
                        <option value="3">Neutral</option>
                    ...
                    <select id="food_and_drink" v-model="form.food_and_drink"
                        class="shadow appearance-none border rounded w-full mt-1 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        <option value="1">Very Dissatisfied</option>
                        <option value="2">Dissatisfied</option>
                        <option value="3">Neutral</option>
                    ...
                    <select id="in_flight_entertainment" v-model="form.in_flight_entertainment"
                        class="shadow appearance-none border rounded w-full mt-1 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        <option value="1">Very Dissatisfied</option>
                        <option value="2">Dissatisfied</option>
                        <option value="3">Neutral</option>
                    ...
                    <select id="baggage_handling" v-model="form.baggage_handling"
                        class="shadow appearance-none border rounded w-full mt-1 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                        <option value="1">Very Dissatisfied</option>
                        <option value="2">Dissatisfied</option>
                        <option value="3">Neutral</option>
